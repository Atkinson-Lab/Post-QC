...
for i in {1..22}; do vcftools --vcf $DATA.chr${i}.vcf --keep /home/atkinson/PGC-PTSD/LAI/AdmixRef/AAd_refSampleMap_noPEL.txt --recode --out $DATA.REF.chr${i} ;done
...
#and run RFmix
for i in {1..22}; do \
	/home/atkinson/PGC-PTSD/LAI/rfmix/rfmix -f $DATA.cohort.chr${i}.recode.vcf.gz -r $DATA.REF.chr${i}.recode.vcf.gz --chromosome=${i} -m /home/atkinson/PGC-PTSD/LAI/AdmixRef/AAd_refSampleMap_noPEL.txt -g /home/atkinson/recombination_rates_hapmap_b37/HapMapcomb_genmap_chr${i}.txt -n 5 -e 1 --reanalyze-reference --num-threads 32 -o $DATA.rfmix.chr${i} ;done
